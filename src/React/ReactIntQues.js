...
const MyComponent = () => {
  return (
    <ul>
      ...
      <li>
        Component name should always start with a capital letter. thats how a
        norm. Component can be empty, or to be precise can take a stae or props.
      </li>
